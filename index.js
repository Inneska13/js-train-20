...
function Vehicle(brand, model, year, mileage) {
  ...
  //     return object;
  //   } else {
  //     return new Vehicle(brand, model, year, mileage);
  //   }
}
...
Car.prototype.brake = function (decrease) {
  this.speed -= decrease;
  console.log(
    `Автомобіль ${this.brand} ${this.model} зменшив до штдкості ${this.speed} км/год`
  );
};
...
ElectricCar.prototype.toString = function () {
  console.log(`${this.brand} ${this.model} ${this.year} - Батарея: ${this.batteryCapacity} kWh
	`);
};
